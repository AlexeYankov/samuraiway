...
import profileReducer from "../../../../state/profileState/ProfileStateReducer";
...
const TextAreaComponent: React.FC<TextAreaType> = ({ accept, closeFn, value, onChange, shorts }) => {
  ...
  return (
    <div className={s.profileInfo__CRUDarea}>
      ...
      <div className={s.profileInfo__CRUDarea__buttons}>
        <button className={s.profileInfo__CRUDarea__send} onClick={() => dispatch(addPostReducer(time, value, img, music, video))}>
