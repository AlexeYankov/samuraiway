import f from "../components/Profile/Components/BarComponent/BarComponent.module.css";
...
const NavListTags: NavListTagsType[] = [
  {
    id: 0,
    tag: "Profile",
    icon: ProfilePic,
